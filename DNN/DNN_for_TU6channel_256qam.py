...
for i in [4,5,6,7]:
    ...
    for j in [7]:
        ...
        mp = f"D://MLforSchool//DNN//0119_TU6_CR10_DnnModel//0222_TU6lab2_func2_train40000_snr{snr}_{first_nodes}_{second_nodes}_{third_nodes}_{four_nodes}_adam0.0001_b{i}_time{j}.h5"
        ...
        save_path = f'D://MLforSchool//DNN//dnn_loss_pic//0222_TU6lab2_func2_train40000_{first_nodes}_{second_nodes}_{third_nodes}_{four_nodes}_adam0.0001_bit{i}_time{j}.png'
        plt.savefig(save_path)
        # plt.show()
        #######################################################################################################
        predict_ans = np.clip(model.predict(combined_output), -20, 20)#訓練好model使用predict預測看看在訓練的model跑的回歸線
        ...
        csv.T.to_csv(f'D://MLforSchool//dnn_experiments//channel//tu6_snr17_to_21//0222_mlp_lab2_func2_snr17_to_21_Ui5_to_8_LLR_result_40000_{first_nodes}_{second_nodes}_{third_nodes}_{four_nodes}_adam0.0001_b{i}_time{j}.csv')
