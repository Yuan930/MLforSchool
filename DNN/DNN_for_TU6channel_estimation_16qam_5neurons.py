...
first_nodes = 84   #105*4/5
second_nodes = 168  #210*4/5
third_nodes = 126   #增加的隱藏層
fourth_nodes = 84   #105*4/5
fifth_nodes = 48    #60*4/5
...
#         print("bit%d,第%d次"% (i,j))
        ...
        mp = f"D:\\py3710\\py_train_data\\0509yuan_16qam_17dB_cr10_TU6\\DNN_hdf5\\0523_(-4,4)_{first_nodes}_{second_nodes}_{third_nodes}_{fourth_nodes}_{fifth_nodes}adadelta_epoch{epochs}_batch{batch_size}_bit{i}_preLLR{j}.h5"
        ...
        save_path = f'D:\\py3710\\py_train_data\\0509yuan_16qam_17dB_cr10_TU6\\DNN_pic\\0523_(-4,4)_{first_nodes}_{second_nodes}_{third_nodes}_{fourth_nodes}_{fifth_nodes}adadelta_epoch{epochs}_batch{batch_size}_bit{i}_hdf5LLR{j}.png'
...
#         #######################################################################################################
    ...
    # a = transpose(arr)
    # a = DataFrame(a)
    # a.to_csv(f'D:\\py3710\\py_train_data\\0509yuan_16qam_17dB_cr10_TU6\\DNN_predict_ans\\0523_(-20,20)_{first_nodes}_{second_nodes}_{third_nodes}_{fourth_nodes}_{fifth_nodes}adadelta_epoch{epochs}_batch{batch_size}_bit{i}_preLLR.csv')
