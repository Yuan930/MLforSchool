...
csv.T.to_csv(f'D://MLforSchool//dnn_experiments//channel//mlp_lab4_16qam_10_15_Max_Log_b{i}channel_{first_nodes}_{second_nodes}_{third_nodes}_{four_nodes}.csv')
