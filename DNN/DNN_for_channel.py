...
for i in range(bit):
    ...
    model.fit(list_x_train_feature, list_y_train_ans, batch_size=batch_size, epochs=epochs ,verbose=1,validation_data=(list_x_valid_feature, list_y_valid_ans))
    #model.add(Dense(32, input_dim=x_train.shape[1],  kernel_initializer='normal',activation='relu'))
# ,validation_data=(list_x_valid_feature, list_y_valid_ans)
    ...
    csv.T.to_csv(f'D://MLforSchool//dnn_experiments//channel//mlp_without_valid_answer_lab4_16qam_10_15_b{i}channel_35_70_35_20.csv')
