...
for i in range(8):
    ...
    for j in range(1):
        train_feature_csv = pd.read_csv('D:\\MLforSchool\\data\\256qam_for_channel\\awgn_256qam_train\\lab1_256qamUi_coderate10_snr17_20000train_new.csv')
        list_x_train_feature = feature_csv_change_to_list(train_feature_csv)
        train_ans_csv = pd.read_csv(f'D:\\MLforSchool\\data\\256qam_for_channel\\awgn_256qam_train\\ans\\lab1_LogMap_snr17_LLR_result_b{i}_20000_new.csv')
        y_train_ans = train_ans_csv.iloc[0: ,1:]
        list_y_train_ans = list(y_train_ans.values.flatten())

        test_ans_csv = pd.read_csv(f'D:\\MLforSchool\\data\\256qam_for_channel\\awgn_256qam_test\\ans\\lab2_LogMap_snr17_LLR_result_b{i}_4000.csv')
        test_feature_csv = pd.read_csv('D:\\MLforSchool\\data\\256qam_for_channel\\awgn_256qam_test\\lab2_256qamUi2_cr10_snr17_4000test_positive.csv')
