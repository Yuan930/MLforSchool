...
for j in range(1):
    train_feature_csv = pd.read_csv('D:\\MLforSchool\\data\\256qam_for_channel\\256qam_train\\lab1_256qamUi_coderate10_snr17_20000train.csv')
    ...
    train_ans_csv = pd.read_csv(f'D:\\MLforSchool\\data\\256qam_for_channel\\256qam_train\\ans\\lab1_LogMap_snr17_LLR_result_b{i}_20000.csv')
    y_train_ans = train_ans_csv.iloc[0: ,1:]
    list_y_train_ans = list(y_train_ans.values.flatten())

    test_ans_csv = pd.read_csv(f'D:\\MLforSchool\\data\\256qam_for_channel\\256qam_test\\ans\\lab1_LogMap_snr17_LLR_result_b{i}_4000.csv')
    test_feature_csv = pd.read_csv('D:\\MLforSchool\\data\\256qam_for_channel\\256qam_test\\lab1_256qamUi_coderate10_snr17_4000test.csv')
    ...
    mp = f"D://MLforSchool//DNN//snr{snr}_{first_nodes}_{second_nodes}_{third_nodes}_LogMap_modelb{i}.h5"
    ...
    csv.T.to_csv(f'D://MLforSchool//dnn_experiments//channel//mlp_lab1_256qam_snr17_10_15_LogMap_b{i}channel_{first_nodes}_{second_nodes}_{third_nodes}.csv')

    predict_csv = pd.read_csv(f'D://MLforSchool//dnn_experiments//channel//mlp_lab1_256qam_snr17_10_15_LogMap_b{i}channel_{first_nodes}_{second_nodes}_{third_nodes}.csv')
