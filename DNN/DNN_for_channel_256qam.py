...
for j in range(1):
    ...
    epochs = 50#代表疊帶40次(總共要用全部的訓練樣本重複跑幾回合)
    ...
    mp = f"D://MLforSchool//DNN//lab4_snr{snr}_{first_nodes}_{second_nodes}_{third_nodes}_{four_nodes}_LogMap_modelb{i}.h5"
...
average_mean_result = trimmean(a, 0.4)
