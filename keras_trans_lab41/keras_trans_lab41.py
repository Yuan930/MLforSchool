...
data_1 = pd.read_csv('D://MLforSchool//dnn_experiments//mlp_predict_answer_lab1_16qam_10_15_100.csv')
...
print(data_1)
data2 = data_1
aa = data_1.to_csv('D://MLforSchool//dnn_experiments//lab1_trans_answer_mlp_16qam_10_15_100.csv')
bb = data2.to_csv('D://MLforSchool//dnn_experiments//lab1_H_BER_16qam_10_15_100_DNN.csv')#為了要算BER，估測出來的H用來等化
